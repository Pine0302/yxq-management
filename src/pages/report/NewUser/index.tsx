...
import { newUserPageInfo } from './service';
...
const tableRequest = async (params?: { pageSize: number; current: number }) => {
  const res = await newUserPageInfo({
    ...params,
...
const printOrders = (params) => {
  ...
  window.location.href = `/adminapi/report/downloadNewUserExcel?${query}`;
};
...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<TableListItem>[] = [
    ...
    },
    {
      ...
      hideInTable: true,
      search: {
        transform: (value) => ({ hasOrder: value }),
      },
    },
