...
import { KitchenUserTableWrapper, SystemAdminTable, TableListItem } from './data';

/** 获取配送员列表 */
export async function sysRolePageInfo(
  params: { current?: number; pageSize?: number; pageNum?: number },
  options?: { [key: string]: any },
) {
  return request<KitchenUserTableWrapper>('/adminapi/system/role/page_info', {
    method: 'GET',
    params: {
      ...params,
    },
